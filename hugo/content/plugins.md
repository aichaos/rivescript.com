...
* Visual Studio Code:
    * [rivescript](https://marketplace.visualstudio.com/items?itemName=anthonymoi.rivescript) by Anthony MOI
    * [RiveScript Language Support](https://marketplace.visualstudio.com/items?itemName=kjleitz.vscode-rivescript) by kjleitz
